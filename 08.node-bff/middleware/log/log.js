...
export default (options = {}) => {
  let contextLogger = {}, // 错误日志等级对象，最后会赋值给 ctx 上，用于打印各种日志
    appenders = {}, // 日志配置
  ...
  appenders.all = {
    ...
    pattern: 'task-yyyy-MM-dd.log', // 占位符，紧跟 filename 后面
    alwaysIncludePattern: true // 是否总有后缀名
  }

  // 环境变量为 dev local development 认为是开发环境
